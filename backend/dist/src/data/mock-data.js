...
exports.reportVault = exports.laborStats = exports.contractorMetrics = exports.teamMembers = exports.roles = exports.contractHistory = exports.contracts = exports.quotes = exports.vendors = exports.tasks = exports.materials = exports.updates = exports.projects = void 0;
exports.projects = [
    {
        id: 'p1',
        name: 'Skyline Plaza',
        ...
        pocDetails: {
            ...
            costBreakdown: {
                labor: 551007,
                materials: 1576904,
                subcontractors: 125000,
                other: 225634
            },
            completionPercentage: { calculated: 20.65, isManual: false },
            revenueRecognized: 3097500,
            invoicedAmount: 5000000,
            unbilledRevenue: 0,
            deferredRevenue: 1902500,
            recognizedProfit: 618955,
            periodClosing: { lastCalculatedPeriod: '2024-05', approvalStatus: 'Approved' },
            historicalMetrics: [
                { period: 'Jan', budget: 500000, actual: 480000, revenue: 600000 },
                { period: 'Feb', budget: 1200000, actual: 1150000, revenue: 1500000 },
                { period: 'Mar', budget: 1800000, actual: 1900000, revenue: 2200000 },
                { period: 'Apr', budget: 2400000, actual: 2478545, revenue: 3097500 },
                { period: 'May', budget: 3000000, actual: 2478545, revenue: 3097500 }
            ]
        },
        team: [
    ...
    },
    {
        ...
        pocDetails: {
            ...
            costBreakdown: {
                labor: 3000000,
                materials: 1500000,
                subcontractors: 800000,
                other: 200000
            },
            completionPercentage: { calculated: 68.75, isManual: false },
            revenueRecognized: 6875000,
            invoicedAmount: 7000000,
            unbilledRevenue: 0,
            deferredRevenue: 125000,
            recognizedProfit: 1375000,
