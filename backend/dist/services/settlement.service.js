...
class SettlementService {
    static generateSuggestedSettlement(vendorId, projectId, basis) {
        ...
        let justification = '';
        if (basis === 'POC') {
            workPercentage = ((_a = project.pocDetails) === null || _a === void 0 ? void 0 : _a.completionPercentage.isManual)
                ? project.pocDetails.completionPercentage.manualOverride || 0
                : ((_b = project.pocDetails) === null || _b === void 0 ? void 0 : _b.completionPercentage.calculated) || 0;
            ...
            const totalProgress = ((_c = project.pocDetails) === null || _c === void 0 ? void 0 : _c.completionPercentage.calculated) || 0;
            if (totalProgress < 90) {
    ...
    static getRetentionAlerts(projectId) {
        ...
        if (totalProgress >= 90) {
            ...
            const projectVendors = mock_data_1.vendors.filter(v => v.projects.includes(project.name));
            projectVendors.forEach(vendor => {
                var _a;
                // Check if retention hasn't already been requested
                const alreadyRequested = (_a = vendor.settlementRequests) === null || _a === void 0 ? void 0 : _a.some(r => r.projectId === projectId && r.basis === 'Retention');
                if (!alreadyRequested) {
                    const contract = mock_data_1.contracts.find(c => c.vendor === vendor.name);
